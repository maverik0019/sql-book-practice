...
--Para cada año de tiendas de ropa de mujer,
--¿en qué porcentaje están las ventas respecto 
--al año base (primer año con datos)?
...
--FACIL!!Para cada año de tiendas de ropa de mujer,
--¿en qué porcentaje están las ventas respecto 
--al año base (primer año con datos)?
...
--Cada fila te dice: en este mes, las ventas fueron X,
-- y el promedio de las ventas de los últimos 12 meses 
--incluyendo este) fue Y.
...
--Esta query arma, para cada mes calendario entre 1993 y 2020, 
--la lista de ventas de 
--ropa de mujer de los últimos 12 meses, usando una tabla calendario
--para manejar correctamente los meses en que no hay datos.
...
-- Calculating cumulative values(forma facil)
SELECT sales_month
,sales
...
--Calculating cumulative values( forma dificil)
...
--EXTRA QUERY:lo mismo peor sin WINDOW
SELECT 
    sales_month, 
    sales,
